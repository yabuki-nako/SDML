...
//     var submitButtonId = $(document.activeElement).attr('id');
//     var formData = $(this).serialize();

//     if (submitButtonId === 'accept') {
//       collectData(formData); // Call the function with formData as an argument
//     }
//   });
// });

// // Define collectData function outside of the event handler
// function collectData(formData) {
//   // Extract data from formData or directly access form fields
//   var appointmentID = formData.appointmentID;
//   var pname = formData.pname;
//   var email = formData.email;
//   var appDate = formData.appDate;
//   var Time_schedule = formData.Time_schedule;
