    ...
    <section id="services" class="services sections-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header">
          <h2>Our Services</h2>
          <p>SDML aims to be the premier choice for medical monitoring and diagnostic evaluation in Laguna and Batangas. We envision ourselves to be an expanding group of medical practitioners delivering quality and unparalleled service that reaches various areas of the region.</p>
        </div>
