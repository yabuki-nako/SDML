...
if ($result1->num_rows > 0) {
    while ($row = $result1->fetch_assoc()) {
        ...
        if ($row['App_status'] == 'Cancelled') {
          ...
          echo "<td><button type='button'   class='btn btn-success btn-accept' onclick=\"openModal1('" . $row['appointment_ID'] . "')\" data-toggle='modal' data-target='#viewehr' disabled >View</button>";        
          echo "<td><button type='button' class='btn btn-success btn-accept' onclick=\"openModal2('" . $row['appointment_ID'] . "')\" data-toggle='modal' data-target='#fileupload' disabled>Electronic Health Records</button>";        
        } elseif ($row['App_status'] ==='Done') {
          echo "<td><span style='color: #008374;'>" . $row['App_status'] . "</span></td>";
          echo "<td><button type='button' class='btn btn-success btn-accept' onclick=\"openModal1('" . $row['appointment_ID'] . "')\" data-toggle='modal' data-target='#viewehr'>View</button>";        
          echo "<td><button type='button' class='btn btn-success btn-accept' onclick=\"openModal2('" . $row['appointment_ID'] . "')\" data-toggle='modal' data-target='#fileupload'>Electronic Health Records</button>";        
        }else {
          echo "<td>" . $row['App_status'] . "</td>";
          echo "<td><button type='button' class='btn btn-success btn-accept' onclick=\"openModal1('" . $row['appointment_ID'] . "')\" data-toggle='modal' data-target='#viewehr'>View</button>";        
          echo "<td><button type='button' class='btn btn-success btn-accept' onclick=\"openModal2('" . $row['appointment_ID'] . "')\" data-toggle='modal' data-target='#fileupload'>Electronic Health Records</button>";        
